            ...
            <div className="w-2/4 mx-auto mt-10 border-2 border-black flex-col text-center ">
                ...
                <form >
                    {(page===1) && 
                        ...
                        <input type="text" id="name" name="name" className="  border-2 border-fitify-purple h-9 w-4/6 form-field col-span-2"></input>
                        <label htmlFor="surname" className=" pr-3.2 mt-5">Last name:</label>
                        <input type="text" id="surname" name="surname" className=" mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="username" className=" pr-3.2 mt-5">Username:</label>
                        <input type="text" id="username" name="username" className="mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="password" className=" pr-3.2 mt-5">Password:</label>
                        <input type="password" id="password" name="password" className="mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="password2" className=" pr-3.2 mt-5">Repeat password:</label>
                        <input type="password" id="password2" name="password2" className="mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                    ...
                    {(page===2) &&
                        ...
                        <input type="text" id="email" name="email" className=" border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="phone" className=" pr-3.2 mt-5">Phone number:</label>
                        <input type="text" id="phone" name="phone" className=" mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="address" className=" pr-3.2 mt-5">Address:</label>
                        <input type="text" id="address" name="address" className=" mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="city" className=" pr-3.2 mt-5">City:</label>
                        <input type="text" id="city" name="city" className=" mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
                        <label htmlFor="country" className=" pr-3.2 mt-5">Country:</label>
                        <input type="text" id="country" name="country" className=" mt-5 border-2 border-fitify-purple w-4/6 h-9 form-field col-span-2"></input>
